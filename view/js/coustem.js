...
if ($(".ourImg").length) {
	...
	$(".ourImg").css({
		"background": "url('images/about-us/" + ImgName + "')no-repeat center top"
	});
}
...
$(".price-table .label_radio").on('click', function () {
	if ($(this).parent("td").parent("tr").hasClass("active")) {} else {
